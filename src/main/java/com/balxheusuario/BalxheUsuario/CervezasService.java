...
public class CervezasService {
	...
	public CervezasService() {
		...
		lista.add(new Cervezas ("Pacifico Clara 355ml", "Pacífico Clara es una cerveza mexicana producida por la cervecería Grupo Modelo. Se trata de una cerveza de tipo Lager, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo suave y refrescante. Se caracteriza por su sabor suave y balanceado, así como por su color dorado claro y su espuma blanca y consistente.", 120, 22, "pacifico-clara.png"));
        	lista.add(new Cervezas ("Bud Light 355ml", "Bud Light es una cerveza americana producida por Anheuser-Busch. Se trata de una cerveza de tipo Light Lager, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo suave y refrescante. Se caracteriza por su sabor ligero y su color dorado claro, así como por su espuma blanca y consistente.", 100, 25, "bud-light.png"));
        	lista.add(new Cervezas ("XX 355ml", "XX es una cerveza mexicana producida por la cervecería Cuauhtémoc Moctezuma. Se trata de una cerveza de tipo Lager, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo suave y refrescante. Se caracteriza por su sabor suave y balanceado, así como por su color dorado claro y su espuma blanca y consistente.", 80, 22, "xx.png"));
        	lista.add(new Cervezas ("Carta Blanca 355ml", "Carta Blanca es una cerveza mexicana producida por la cervecería Cuauhtémoc Moctezuma. Se trata de una cerveza de tipo Lager, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo suave y refrescante. Se caracteriza por su sabor suave y balanceado, así como por su color dorado claro y su espuma blanca y consistente.", 90, 21, "carta-blanca.png"));
        	lista.add(new Cervezas ("Montejo 355ml", "Montejo es una cerveza mexicana producida por la cervecería Cuauhtémoc Moctezuma. Se trata de una cerveza de tipo Lager, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo suave y refrescante. Se caracteriza por su sabor suave y balanceado, así como por su color dorado claro y su espuma blanca y consistente.", 70, 20, "montejo.png"));}
//Metodo CRUD
